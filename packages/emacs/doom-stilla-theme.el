...
(def-doom-theme doom-stilla
  ...
  ((bg         '("#0D0D0D" nil       nil))
   ...
   (base1      '("#EEE1E1" "#262626" "brightblack"))
   (base2      '("#E5E4E3" "#303030" "brightblack"))
   (base3      '("#F6E1C4" "#3A3A3A" "brightblack"))
   (base4      '("#E3E5E7" "#444444" "brightblack"))
   (base5      '("#F0E0E8" "#585858" "brightblack"))
   (base6      '("#D7E7EF" "#626262" "brightblack"))
   (base7      '("#FAFAFA" "#767676" "brightblack"))
   (base8      '("#E4E6EB" "#a8a8a8" "white"))
   (fg         '("#F2F2F2" "#e4e4e4" "brightwhite"))
   (fg-alt     '("#E1E5EB" "#bcbcbc" "white"))

   (grey '("#E4E6EB" nil nil))

   (red         '("#EEE1E1" "#ff0000" "red"))
   (orange      '("#F4E1D0" "#ff5f00" "brightred"))
   (green       '("#E5E4E3" "#afff00" "green"))
   (teal        '("#DCE6E9" "#00d7af" "brightgreen"))
   (yellow      '("#F6E1C4" "#ffd700" "brightyellow"))
   (blue        '("#E3E5E7" "#5fafff" "brightblue"))
   (dark-blue   '("#DFE5EA" "#d7ffff" "blue"))
   (magenta     '("#F0E0E8" "#d787d7" "brightmagenta"))
   (violet      '("#F0E0E8" "#d787af" "magenta"))
   (cyan        '("#E9E4D8" "#5fd7ff" "brightcyan"))
   (dark-cyan   '("#DCE6E9" "#00d7af" "cyan"))
